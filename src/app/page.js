      ...
      <div className="max-w-6xl mx-auto">
        <header className="mb-12">
          ...
          <h2 className="text-4xl md:text-6xl font-black text-slate-900 leading-tight">
            Strumenti digitali,
            <br />
            <span className="text-slate-600">senza impronte.</span>
          </h2>
        </header>
        <main>
            ...
            >
              <div className="relative z-10">
                ...
                <h3 className="text-3xl font-bold mb-3 tracking-tight">
                  NoMark<span className="text-green-700">Pass</span>
                </h3>
              ...
              <div className="relative z-10 mt-8 flex items-center gap-2 text-green-700 font-bold text-xs uppercase tracking-widest">
                Genera Password{" "}
                <ArrowRightIcon className="w-4 h-4 group-hover:translate-x-2 transition-transform" />
              </div>
